...
from myfuns import get_displayed_movies, get_recommended_movies, get_popular_movies
...
sidebar = html.Div(
    [
        ...
        dbc.Nav(
            [
                dbc.NavLink("Collaborative", href="/collaborative", active="exact"),
            ],
            vertical=True,
            pills=True,
        ),
        ...
        return html.Div(
            [
                ...
                dcc.Loading(
                    [
                        dcc.Link(
                            "Try again", href="/collaborative", refresh=True, className="mb-2 d-block"
                        ),
                        html.Div(
                            className="row row-cols-1 row-cols-5",
                    ...
                    html.Div(
                        [
                            *[
                                ...
                                for idx, movie in get_popular_movies().iterrows()
                            ],
                        ],
                        className="row row-cols-1 row-cols-5",
                    ),
